...
class Comment_Remover {
    ...
    static fileContents: string = '';
    static atCharIndexInFileContents: number = 0;
    static inSingleLineComment: boolean = false;
    static inMultiLineComment: boolean = false;
    static there_are_more_characters_to_process: boolean = false;
    ...
    static removeCommentsIfAny(code: string) {
